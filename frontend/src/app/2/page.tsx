...
export default function WelcomePage() {
  ...
  const handleCTAClick = (ctaType: string, source: string) => {
    ...
    const buttonTextMap: { [key: string]: string } = {
      'try_jules_free': 'Try Jules Free.',
      'get_profile_pic_review': 'Try Jules Free.',
      'get_started_free': 'Try Jules Free.',
      'join_jules_beta': 'Try Jules Free.'
    };
        ...
        <div className="text-center text-white max-w-4xl mx-auto w-full">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
              An AI that tells you what women actually see.
            </h1>
            
            {/* Subhead - Curiosity Hook */}
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto px-2 sm:px-4">
              Get honest, judgment-free feedback on your dating photos, and improve your odds.
            </p>
          </div>

          {/* CTA Button - Curiosity Hook */}
          <div className="mb-8 sm:mb-12">
            <Link
              href="/free-experience/profile-pic-review"
              onClick={() => handleCTAClick('try_jules_free', 'hero_section')}
