...
export default function WelcomePage() {
  // Free experience landing page - Variant 1: Emotional Hook
  useEffect(() => {
    // Store landing source in localStorage for tracking through the funnel
    localStorage.setItem('landing_source', '/1');
    localStorage.setItem('landing_variant', 'emotional_hook');
  ...
  const handleCTAClick = (ctaType: string, source: string) => {
    ...
    const buttonTextMap: { [key: string]: string } = {
      'upload_pic_get_feedback': 'Upload a Pic. Get Feedback.',
      'get_profile_pic_review': 'Upload a Pic. Get Feedback.',
      'get_started_free': 'Upload a Pic. Get Feedback.',
      'join_jules_beta': 'Upload a Pic. Get Feedback.'
    };
        ...
        <div className="text-center text-white max-w-4xl mx-auto w-full">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto px-2 sm:px-4">
              Feedback that helps you get noticed, and finally stop getting ghosted.
            </p>
          </div>

          {/* CTA Button - Emotional Hook */}
          <div className="mb-8 sm:mb-12">
            <Link
              href="/free-experience/profile-pic-review"
              onClick={() => handleCTAClick('upload_pic_get_feedback', 'hero_section')}
